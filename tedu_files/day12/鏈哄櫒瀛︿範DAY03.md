...
线性回归、岭回归(C)、多项式回归、决策树、正向激励，随机森林...
...
| 特征1 | 特征2 | ==>  | 1号模型(A, !A) | 2号模型(B, !B) | 3号模型(C) |
| ----- | ----- | ---- | -------------- | -------------- | ---------- |
| 4     | 7     | ==>  | 属于A: 0.9     | 属于B: 0.0     | C: 0.1     |
| 3.5   | 8     | ==>  | 属于A: 0.8     | 属于B: 0.1     | C: 0.1     |
| 1.2   | 1.9   | ==>  | 属于A: 0.1     | 属于B: 0.8     | C: 0.1     |
| 5.4   | 2.2   | ==>  | 属于A: 0.1     | 属于B: 0.3     | C: 0.6     |
